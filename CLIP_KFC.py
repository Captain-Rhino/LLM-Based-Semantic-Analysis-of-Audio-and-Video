...
# 配置路径
video_path = "test_movie.mp4"

# 动态生成输出目录名，根据视频名称生成对应文件夹
video_name = os.path.splitext(os.path.basename(video_path))[0]  # 获取视频文件名（去掉扩展名）
asr_json_path = f"transcription_{video_name}.json"
